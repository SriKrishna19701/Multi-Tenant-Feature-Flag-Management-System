        ...
        <div className="min-h-screen bg-slate-50 px-4 py-12 flex items-center justify-center">
            <div className="w-full max-w-md rounded-[2rem] bg-white/95 p-10 shadow-[0_30px_60px_-30px_rgba(15,23,42,0.3)] ring-1 ring-slate-200">
                <div className="mb-8 space-y-3">
                    <span className="inline-flex rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">Super Admin</span>
                    <h2 className="text-3xl font-semibold tracking-tight text-slate-900">Super admin access</h2>
                    <p className="text-sm text-slate-600">Sign in to manage the platform and tenant organizations.</p>
                </div>
